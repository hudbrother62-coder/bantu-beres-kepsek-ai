...
const required = [
  ...
  "assets/supervision-instruments.js",
  ...
  "supabase/migrations/20260903170000_add_academic_supervision.sql",
  "vercel.json",
];

for (const file of required) await access(resolve(root, file));

for (const file of ["assets/app.js", "assets/document-format.js", "assets/session-policy.js", "assets/supervision-instruments.js", "api/config.js", "api/health.js", "api/generate.js", "api/chat.js", "api/analyze-file.js", "lib/gemini.js", "lib/education-standards.js", "lib/public-config.js", "lib/supabase-auth.js"]) {
...
for (const route of ["/auth","/onboarding","/dashboard","/calendar","/profile","/documents","/documents/:path*","/ai","/assistant","/supervision","/team","/templates","/guide","/more","/join"]) {
...
for (const expected of ["renderSupervision", "kepsek_supervisions", "kepsek_teachers", "data-complete-supervision", "exportSupervision"]) {
  if (!appSource.includes(expected)) throw new Error(`Missing operational supervision requirement: ${expected}`);
}
