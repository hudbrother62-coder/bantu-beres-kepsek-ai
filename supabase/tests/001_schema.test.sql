...
select policies_are('public','kepsek_assistant_messages',array['kepsek_assistant_messages_delete_own','kepsek_assistant_messages_insert_own','kepsek_assistant_messages_select_own']);
